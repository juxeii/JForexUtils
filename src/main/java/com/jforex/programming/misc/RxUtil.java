...
public class RxUtil {
    ...
    public static Observable<Long> positionTaskRetry(final Observable<? extends Throwable> errors) {
        return errors
    ...
    public static Observable<Integer> retryCounter(final int maxRetries) {
