...
public final class PositionSwitcher {
    ...
    private final void configureFSM() {
        ...
        fsmConfig
                ...
                .permitDynamic(FSMTrigger.MERGE_DONE, this::nextStateByDirection)
    ...
    private FSMState nextStateByDirection() {
        return nextStatesByDirection.get(positionOrders.direction());
    }
