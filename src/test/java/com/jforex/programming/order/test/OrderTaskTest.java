...
public class OrderTaskTest extends InstrumentUtilForTest {
    ...
    @Before
    public void setUp() {
        orderTask = new OrderTask(orderTaskExecutorMock, orderUtilHandlerMock);
    }
    ...
    public class SubmitOrderSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.submitOrder(buyParamsEURUSD);
        }
    ...
    public class CloseSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.close(orderForTest);
        }
    ...
    public class SetLabelSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.setLabel(orderForTest, newLabel);
        }
    ...
    public class SetGTTSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.setGoodTillTime(orderForTest, newGTT);
        }
    ...
    public class SetRequestedAmountSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.setRequestedAmount(orderForTest, newRequestedAmount);
        }
    ...
    public class SetOpenPriceSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.setOpenPrice(orderForTest, newOpenPrice);
        }
    ...
    public class SetSLSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.setStopLossPrice(orderForTest, newSL);
        }
    ...
    public class SetTPSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.setTakeProfitPrice(orderForTest, newTP);
        }
    ...
    public class CancelSLSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.cancelStopLossPrice(orderForTest);
        }
    ...
    public class CancelTPSetup {
        ...
        public void setUp() {
            ...
            observable = orderTask.cancelTakeProfitPrice(orderForTest);
        }
