...
public class OrderEventTypeEvaluatorByMaps implements OrderEventTypeEvaluator {
    ...
    @Override
    public final OrderEventType get(final OrderMessageData orderEventData,
    ...
    private final boolean isEventByReason(final OrderMessageData orderEventData) {
        return orderEventData.messageReasons().size() == 1;
    }

    private final OrderEventType refineWithCallRequest(final OrderEventType orderEventType,
    ...
    private final OrderEventType eventByReason(final OrderMessageData orderEventData) {
